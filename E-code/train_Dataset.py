...
class TrainDataset(torch.utils.data.Dataset):
    ...
    def initialize(self, dataset_root_path):
        ...
        for entry in tqdm(training_data_list):
            ...
            # Processing question dictionary
            ...
            # Processing features
            slow_code_list = os.listdir(f"{dataset_root_path}/{entry}/Acc_tle_solutions")
            for some_code in slow_code_list:
                ...
                # Processing IO case test path and original data path
                io_case_test_path = f"{dataset_root_path}/{entry}/IO Case Test Dictionary.txt"
                original_data_path = f"{dataset_root_path}/{entry}/acc_tle_solutions/{some_code}"
...
def reindent_code_function(code_string):
    """
    Reindent the given code string in the same way that the Github dataset was indented
    """
